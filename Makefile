...
build:
	...
	mv ascr_2.2.4.tar.gz package-build/

check:
	R CMD check package-build/ascr_2.2.4.tar.gz --no-tests --no-examples

install:
	R CMD INSTALL package-build/ascr_2.2.4.tar.gz --install-tests
