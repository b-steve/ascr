// Working verson of code with a(theta) by quadrature.
DATA_SECTION
...
SEPARABLE_FUNCTION void g_cluster(int i, const dvariable& D, const dvariable& ssb0, const dvariable& ssb1, const dvariable& sigmass, const dvariable& x_i, const dvariable& y_i)
