...
#' @param mask a list or a data frame. If it is provided, it will be passed to the modelling process directly, please make
#'             it satisfies the requirements of the modelling. It is recommended to use argument "control_create_mask",
#'             or the function "create.mask()" to create it.
...
#' @param sound.speed a scalar, sound speed with unit of "m/s".
#' @param sv_link a list; this is mostly for development purpose, not recommended to use
#' @param ...
#' 
#'
